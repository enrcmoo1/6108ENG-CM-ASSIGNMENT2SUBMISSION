...
class AuthorSessionsControllerTest < ActionController::TestCase
  ...
  test "should create author_session" do
    assert_difference('AuthorSession.count') do
      post :create, author_session: { create: @author_session.create, destroy: @author_session.destroy, new: @author_session.new }
    end
  ...
  test "should update author_session" do
    put :update, id: @author_session, author_session: { create: @author_session.create, destroy: @author_session.destroy, new: @author_session.new }
    assert_redirected_to author_session_path(assigns(:author_session))
  end
